...
class BlockChain(object):
    ...
    def add_transaction(self, sender_blockchain_address,
        ...
        print("## DEBUG - add_transactions ##")
        print("sender_blockchain_address: ", sender_blockchain_address)
        print("recipient_blockchain_address: ",recipient_blockchain_address)
        print("value: ", value)
    ...
    def create_transaction(self, sender_blockchain_address,
        ...
        print("## DEBUG - create_transaction ##")
        print("sender_blockchain_address: ", sender_blockchain_address)
        print("recipient_blockchain_address: ",recipient_blockchain_address)
        print("value: ", value)
        print("sender_public_key: ", sender_public_key)
